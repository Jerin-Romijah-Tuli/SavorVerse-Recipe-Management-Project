    ...
    <div class="container">
        <div class="row">
                ...
                <div class="recipe-grid">
                    ...
                    <img src="{{ asset('images/recipes/Roastedlamb.jpg') }}" alt="Roasted lamb Recipe">
                                            </div>
                    <div class="recipe-content">
                     <h4><li><a href="{{ url('/') }}">Roasted lamb Recipe</a></li></h4>
                        <ul class="recipe-info">
                        <a href="{{ route('australian')}}" class="category-img">
                            <li><i class="far fa-clock"></i> 130 mins</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="recipe-grid">
                    <div class="recipe-img">
                    <img src="{{ asset('images/recipes/dimsum.jpg') }}" alt="Dim Sum RECIPE">
                                            </div>
                    <div class="recipe-content">
                     <h4><li><a href="{{ url('/') }}"> Dim Sum RECIPE</a></li></h4>
                        <ul class="recipe-info">
                        <a href="{{ route('chinese')}}" class="category-img">
                ...
                <div class="recipe-grid">
                    ...
                    <div class="recipe-content">
                     <h4><li><a href="{{ url('/') }}">Pasta Primavera Recipe</a></li></h4>
                        <ul class="recipe-info">
                        <a href="{{ route('italian') }}" class="category-img">
                ...
                <div class="recipe-grid">
                    ...
                    <div class="recipe-content">
                     <h4><li><a href="{{ url('/') }}">Saucy Ramen Noodles Recipe</a></li></h4>
                        <ul class="recipe-info">
                        <a href="{{ route('japanese') }}" class="category-img">
                            <li><i class="far fa-clock"></i> 20 mins</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="recipe-grid">
                    <div class="recipe-img">
                    <img src="{{ asset('images/recipes/tteokbokki.jpg') }}" alt="VEGAN TTEOKBOKKI RECIPE">
                                            </div>
                    <div class="recipe-content">
                     <h4><li><a href="{{ url('/') }}"> VEGAN TTEOKBOKKI RECIPE</a></li></h4>
                        <ul class="recipe-info">
                        <a href="{{ route('korean')}}" class="category-img">
                            <li><i class="far fa-clock"></i> 130 mins</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="recipe-grid">
                    <div class="recipe-img">
                    <img src="{{ asset('images/recipes/padthai.jpg') }}" alt="Pad Thai RECIPE">
                                            </div>
                    <div class="recipe-content">
                     <h4><li><a href="{{ url('/') }}"> Pad Thai RECIPE</a></li></h4>
                        <ul class="recipe-info">
                        <a href="{{ route('thai')}}" class="category-img">
                            <li><i class="far fa-clock"></i> 30 mins</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        ...
        @foreach($recipes as $recipe)
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="recipe-grid">
                    <div class="recipe-img">
                        <img src="{{ asset('images/recipes/' . $recipe->image) }}" alt="{{ $recipe->title }}">
                    </div>
                    <div class="recipe-content">
                        <h4><a href="{{ url('/recipe/' . $recipe->id) }}">{{ $recipe->title }}</a></h4>
                        <ul class="recipe-info">
                            <li><i class="far fa-clock"></i> {{ $recipe->preparation_time }} mins</li>
                            <li><i class="fas fa-utensils"></i> {{ ucfirst($recipe->category) }}</li>
                        </ul>
                    </div>
                </div>
            </div>
